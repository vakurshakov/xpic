...
void set_world_geometry(PetscReal _gx, PetscReal _gy, PetscReal _gz, PetscReal _gt, PetscReal _dx, PetscReal _dy, PetscReal _dz, PetscReal _dt, PetscInt _dtp) {
  Dx[0] = dx = _dx;
  Dx[1] = dy = _dy;
  Dx[2] = dz = _dz;
  dt = _dt;
...
void set_world_geometry(PetscInt _gnx, PetscInt _gny, PetscInt _gnz, PetscInt _gnt, PetscReal _dx, PetscReal _dy, PetscReal _dz, PetscReal _dt, PetscInt _dtp) {
  set_world_geometry((PetscReal)_gnx * _dx, (PetscReal)_gny * _dy, (PetscReal)_gnz * _dz, (PetscReal)_gnt * _dt, _dx, _dy, _dz, _dt, _dtp);
}
