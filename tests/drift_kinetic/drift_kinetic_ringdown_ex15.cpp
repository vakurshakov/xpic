...
static constexpr char help[] =
  "Ion-sound density-ringdown test with the drift_kinetic_sound_ex19\n"
  "parameters.  It uses the exact paired density loading, quiet velocities\n"
  "and strict nonlinear pushing of drift_kinetic_ringdown_ex7.\n";
