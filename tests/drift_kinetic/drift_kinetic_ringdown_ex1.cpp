...
static constexpr char help[] =
  "Ion-sound density-ringdown test for the drift_kinetic implementation.\n"
  "A charge-neutral sinusoidal density perturbation is loaded into paired\n"
  "electron and ion guiding centers, with zero bulk velocity and E(t=0)=0.\n";

namespace ringdown {

constexpr PetscInt particles_per_cell = 1024;
...
constexpr PetscInt time_steps = 630;
