...
static constexpr char help[] =
  "Long-wavelength ion-sound density-ringdown test for drift_kinetic.\n"
  "It preserves the sound_ex19 parallel plasma parameters and grid while\n"
  "using exact paired density loading, quiet Gaussian velocities and strict\n"
  "adaptive pushing.\n";

namespace ringdown {

constexpr PetscInt particles_per_cell = 5000;
constexpr PetscReal density_amplitude = 0.03;
constexpr PetscReal length_z = 200.0;
constexpr PetscInt cells_z = 20;
constexpr PetscReal time_step = 10.0;
// Five ion-sound periods: omega_th=6.23223e-4 and T=10081.77.
constexpr PetscInt time_steps = 5041;
