...
constexpr double E0 = 9.171024e-06;
constexpr double omega_real = 3.188446e-04;
constexpr double gamma = 1.929230e-05;

constexpr double a_n_e = 2.999971e-02;
constexpr double phi_n_e = -3.012759;
constexpr double a_n_i = 3.000000e-02;
constexpr double phi_n_i = -3.012760;

constexpr double vpar_max_e = 7.9134261186830817e-01;
constexpr double vpar_max_i = 1.1191274207850656e-02;
constexpr double mu_max_e = 1.1741682974559687e-01;
